...
export const Login = () => {
    ...
    return (
        <div className="container d-flex justify-content-center align-items-center mt-5 text-center" >
            <div className="card bg-dark mt-5" style={{ width: "390px", height: "350px" }}>
                <div className="card-title text-light mt-2"><h1>Login</h1></div>
                <div className="card-body">
                    <form onSubmit={HandleSubmit}>
                        <div className="row gap-4">
                            <div className="col-6 mx-auto" style={{ width: "300px" }}>
                                <input type="text" className="form-control" value={LogIn.Email} placeholder="Enter Your E-mail" onChange={(e) => setLogIn({ Email: e.target.value, Password: LogIn.Password })} />
                            </div>
                            <div className="col-6 mx-auto" style={{ width: "300px" }}>
                                <input type="text" className="form-control" placeholder="Enter Your Password" value={LogIn.Password} onChange={(e) => setLogIn({ Password: e.target.value, Email: LogIn.Email })} />
                            </div>
                            <div className="col-6 mx-auto" style={{ width: "300px" }}>
                                <button className="btn btn-primary"> <strong>Login</strong></button>
...
export const Change = () => {
    ...
    return (
        <div className="container d-flex justify-content-center align-items-center mt-5 text-center" >
            <div className="card bg-dark mt-5" style={{ width: "390px", height: "390px" }}>
                <div className="card-title text-light mt-2"><h1>Change Password</h1></div>
                <div className="card-body">
                    <form onSubmit={HandleSubmit}>
                        <div className="row gap-4">
                            <div className="col-6 mx-auto" style={{ width: "300px" }}>
                                <input type="text" className="form-control" value={Change.Email} placeholder="Enter Your E-mail" onChange={(e) => setChange({ Email: e.target.value, NewPassword: Change.NewPassword, Confirm: Change.Confirm })} />
                            </div>

                            <div className="col-6 mx-auto" style={{ width: "300px" }}>
                                <input type="text" className="form-control" placeholder="Enter Your Password" value={Change.NewPassword} onChange={(e) => setChange({ NewPassword: e.target.value, Email: Change.Email, Confirm: Change.Confirm })} />
                            </div>
                            <div className="col-6 mx-auto" style={{ width: "300px" }}>
                                <input type="text" className="form-control" value={Change.Confirm} placeholder="Enter Your Confirm" onChange={(e) => setChange({ Confirm: e.target.value, NewPassword: Change.NewPassword, Email: Change.Email })} />
                            </div>
                            <div className="col-6 mx-auto" style={{ width: "300px" }}>
